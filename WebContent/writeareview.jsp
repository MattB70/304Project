	...
	try	{
		...
		<table>
			<tr>
				...
				<td><input required type="number" name="reviewRating" placeholder="0" min="0" max= "5" title="Please rate your experience between 0 and 5 (5 being an excellent experience)"></td>
			</tr>
		<%
       ...
       if (rstr.first()){
           ...
           return;
				...
				psti.setInt(1, Integer.parseInt(reviewRating));
				psti.setString(2, reviewDate);
				psti.setString(3, customerId);
				psti.setInt(4, Integer.parseInt(productId));
